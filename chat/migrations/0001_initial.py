# Generated by Django 2.0.6 on 2018-06-09 17:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_sesion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='messages', to='chat.ChatSession')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
